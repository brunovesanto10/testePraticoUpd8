    ...
    <form action="search" method="POST">
        ...
        <div class="row">
            <div class="col-sm-2 form-group">
                <label>CPF</label>
                <input type="text" name="cpf" class="form-control" value="" placeholder="CPF do Cliente">
            </div>
            <div class="col-sm-4 form-group">
                <label>Nome</label>
                <input type="text" name="name" class="form-control" value="" placeholder="Nome do Cliente">
            </div>
            <div class="col-sm-3 form-group">
                <label>Data de Nascimento</label>
                <input type="date" name="nascimento" class="form-control" value="" placeholder="Data de Nascimento do Cliente">
            </div>
            <div class="col-sm-3 form-group">
                <label>Sexo</label><br>
        ...
        <div class="row">
            <div class="col-sm-5 form-group">
                ...
                <input type="text" name="endereco" class="form-control" value="" placeholder="Endereço do Cliente">
            </div>
            <div class="col-sm-4 form-group">
                <label>Cidade</label>
                <input type="text" name="cidade" class="form-control" value="" placeholder="Cidade do Cliente">
            </div>
            <div class="col-sm-1 form-group">
                <label>UF</label>
                <input type="text" name="uf" class="form-control" value="" placeholder="UF do Cliente">
            </div>
            <div class="col-sm-1 form-group">
