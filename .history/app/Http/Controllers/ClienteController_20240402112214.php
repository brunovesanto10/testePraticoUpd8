...
class ClienteController extends Controller
{
    ...
    public function search(StoreClienteRequest $request)
    {
        ...
        if ($data['name']) {
            $clientes->orWhere('name', 'LIKE', '%'.$data['name'].'%')->get();
        }
        if ($data['cpf']) {
            $clientes->orWhere('cpf', 'LIKE', "%$data[cpf]%"])->get();
        }
        if ($data['nascimento']) {
            $clientes->orWhere('nascimento', '=', $data['nascimento'])->get();
        }
        if (isset($data['sexo'])) {
            $clientes->orWhere('sexo', '=', $data['sexo'])->get();
        }
        if ($data['endereco']) {
